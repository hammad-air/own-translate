...
Built with the latest Next.js and TypeScript, AISpeak is an advanced voice translation tool. It allows users to speak into the microphone, translate the spoken text to another language, and playback the translation. This project is perfect for those looking to learn how to integrate speech recognition and translation APIs into a Next.js application.
...
```bash
git clone https://github.com/mendsalbert/AI-speak.git
cd AIspeak
```
